lextest: grammar.o lexical_analysis.o symbol.o lex.yy.o util.o
	cc -g -o grammartest grammar.o lexical_analysis.o symbol.o lex.yy.o util.o
...
grammar.o: grammar.c tokens.h util.h
	cc -g -c grammar.c
